              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[var(--gray)]">
                      <a href={BUSINESS_INFO.phoneLink} className="hover:text-[var(--primary)] transition-colors">
                        {BUSINESS_INFO.phone}
                      </a>
                    </p>
                  </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[var(--gray)]">
                      <a href={`mailto:${BUSINESS_INFO.email}`} className="hover:text-[var(--primary)] transition-colors">
                        {BUSINESS_INFO.email}
                      </a>
                    </p>
                  </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[var(--gray)]">
                      {BUSINESS_HOURS.display.weekdays}<br />
                      {BUSINESS_HOURS.display.friday}<br />
                      {BUSINESS_HOURS.display.weekend}
                    </p>
                  </div>
                </div>
              </div>
